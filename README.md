# nvim-treesitter-queries-arduino

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-arduino/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-arduino/actions/workflows/validate.yml)

Neovim tree-sitter queries for **arduino**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-arduino",
...
- [ ] Changes are scoped to `arduino` — do not include files for other languages
